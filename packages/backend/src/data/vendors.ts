...
/**
 * 冷氣維修廠商種子資料。
 * 刻意讓每家有不同強項（價格 / 速度 / 品牌專精 / 女性技師 / 保固），
 * 這樣媒合 agent 的排序才有意義，demo 也才看得出差異。
 *
 * 台北市 = 01（001 中正 002 大同 003 中山 004 萬華 005 信義 006 松山 007 大安
 *              008 南港 009 內湖... 見 geo.generated.ts）
 * 新北市 = 02（013 板橋 024 汐止 030 新店 033 中和 034 永和 039 三重 040 蘆洲...）
 */
export const SEED_VENDORS: Vendor[] = [
  ...
  },
  {
    ...
    coverage: [{ countyCode: '01', districtCodes: ['005', '006', '007', '008', '010', '012'] }],
    rating: 4.8,
    reviewCount: 356,
    completedJobs: 1104,
    ...
    pricing: {
      ...
      items: [
        ...
        { code: 'AC_CLEAN', name: '分離式冷氣深層清洗', minPrice: 1600, maxPrice: 2600, unit: '台' },
...
export const SYMPTOM_TO_ITEMS: Record<string, string[]> = {
  不冷: ['AC_GAS', 'AC_COMP'],
  不夠冷: ['AC_GAS', 'AC_CLEAN'],
  漏水: ['AC_LEAK'],
  滴水: ['AC_LEAK'],
